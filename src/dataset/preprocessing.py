...
class MakeNIERDataset(ABC):
    def __init__(self, reset_db=False, start_date=20170301, until_date=20220228, test_date=20210301, seed=999,
                 preprocess_root='../dataset/d5', root_dir="/workspace/local/src/datagen/ver_4th/db_save", save_processed_data=True, run_pca=False):
        ...
        if run_pca:
            ...
            self.final_data = load_data(os.path.join(self.preprocess_root, f'NIER_R5_data_{start_year}_{test_year}.pkl'))
    ...
    def handle_pca(self):
        ...
        start_year = str(self.start_date)[2:4]
        test_year = str(self.until_date)[2:4]
        save_data(self.final_data, self.preprocess_root, f'NIER_R5_data_{start_year}_{test_year}.pkl')
