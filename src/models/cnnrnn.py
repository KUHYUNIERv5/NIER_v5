...
class SingleInceptionCRNN(nn.Module):
    def __init__(self, obs_dim, fnl_dim, num_dim, lag, dropout, rnn_type, reg):
        super(SingleInceptionCRNN, self).__init__()
        obs_time = lag * 4
        fnl_time = lag * 4 - 2
        ...
        self.fc1 = BasicFC(256 * (lag * 4) + num_dim, 256)
...
class DoubleInceptionCRNN(nn.Module):
    def __init__(self, obs_dim, fnl_dim, num_dim, lag, dropout, rnn_type, reg):
        super(DoubleInceptionCRNN, self).__init__()
        obs_time = lag * 4
        fnl_time = lag * 4 - 2
