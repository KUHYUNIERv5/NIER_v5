...
parser.add_argument('--region', required=True, help='input region')
parser.add_argument('--pm_type', required=True, help='input pm type')
parser.add_argument('--reg', action='store_true', help='input clsreg type')
parser.add_argument('--epoch', required=True, type=int, default=50, help='input epoch')
parser.add_argument('--num_scen', required=True, type=int, default=0, help='input numeric scenario')
parser.add_argument('--exp_name', default='v2_ku', help='experiment name')
parser.add_argument('--model_ver', default='v1', help='model version')
parser.add_argument('--csv_name', default='lambda_1_region_list.csv', help='csv file name')
# parser.add_argument('--lr', required=True, type=float, default=0.0002, help='input running device')

### Change or add arguments here
parser.add_argument('--root_dir',required=False, default='/home/pink/dust/NIER_R5_new/results_consider_height/', help='save directory')

parser.add_argument('--data_dir', type=str, default='/home/pink/dust/NIER_R5_new/data_folder/', help="dataset directory")
parser.add_argument('--rm_region', type=int, required=True, default=0, help="remove region")

parser.add_argument('--gpu_list', nargs='+', type=int, default=[0,1])
...
numeric_scenario = int(args.num_scen)
